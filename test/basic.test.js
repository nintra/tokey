...
describe('basic', () => {
    ...
    test('use two instances', () => {
        const tokeyA = new Tokey()
        const tokeyB = new Tokey(tokeyA.key)

        expect(tokeyA.verify(tokeyB.generate())).toBeTruthy()
        expect(tokeyB.verify(tokeyA.generate())).toBeTruthy()
    })
})
